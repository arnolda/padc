...
\scipy{scipy.linalg.solve(A, b)} ist allerdings ein Löser für
Gleichungssysteme $Ax=b$, der auf der LU-Zerlegung durch
Gaußelimination basiert. Dieser Löser setzt allerdings voraus, dass
die Matrix nicht singulär ist, also eindeutig lösbar.
