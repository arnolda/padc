...
\item Ist Funktion $f$ ungerade (antisymmetrische), also $f(t) = -f(-t)$, so ist
  $\FT(f)(-\omega) = -\FT(f)(\omega)$, ungerade (antisymmetrische).
...
müssen numerisch durch \mbox{(Zeit--)}Mittelung der Daten bestimmt werden. Da
