...
wird.  Hat \argd{A} komplexe Eigenwerte, können auch nichtverschwindende
...
\subsubsection{Beispiel: Fibonaccieigenwerte numerisch}
...
\argd{l} ist hier die Näherung $\lambda$ des Eigenwerts, zu dem der Eigenvektor gesucht wird. Hier gibt die Toleranz an, wie sehr $Ax$ von $\lambda x$ abweichen darf.

\subsubsection{Beispiel: Fibonaccivektoren numerisch}
