...
Mersenne-Twister hat zum Beispiel einen internen Zustand von 2,5
Kilobyte und eine Periode von $\approx 10^{6000}$, was für die meisten
...
zufälliger Wahl der Konstanten wird die Periode meist sehr viel
kürzer sein.
...
belegt. Bis etwa $n=4$ ist die Verwerfungsmethode
...
werden, indem diese auf die Oberfläche projeziert werden, also
...
ist erstaunlicherweise ebenso gleichverteilt, da $\rho(z)$ proportional zum Flächeninhalt
...
Vielzahl von Standardtests. Der Grund davon ist, dass es leider keinen
einzelnen Test gibt, der sicherstellt, dass es keinerlei Korrelationen
in der generierten Folge gibt. Ein solcher Test müßte ja jede mögliche
...
beschrieben standardmäßig auf dem Computer erzeugt und im Bedarfsfall auf
andere Verteilungen transformiert.
