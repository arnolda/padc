...
Observablen $x$ darstellen. Der Erwartungswert dieser Observablen
lässt sich dann bekanntermaßen als
\begin{equation}
  \label{eq:mean}
...
Unter der Annahme, dass die Messungen $x_i$ alle paarweise unabhängig
sind, gilt
\begin{equation}
  \label{eq:errestvar}
...
NumPy implementiert. \scipy{numpy.mean(array)} berechnet den Schätzer
für den Mittelwert, \scipy{numpy.var(array, ddof=1)} den Schätzer
für die Varianz. \argd{ddof} bezeichnet dabei die Anzahl der abhängigen
